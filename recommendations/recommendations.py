...
books_by_category = {
    BookCategory.MYSTERY: [
        ...
        BookRecommendation(id=5, title="Зов Ктулху"),
        BookRecommendation(id=6, title="Оно"),
        BookRecommendation(id=7, title="Кладбище домашних животных"),
        BookRecommendation(id=8, title="Доктор Сон"),
        BookRecommendation(id=9, title="Вий"),
        BookRecommendation(id=10, title="Чужак"),
    ],
